...
export default class XDocTabsElement extends HTMLElement {
  ...
  /**
   * Maximal number of tabs that can be opened.
   *
   * @property
   * @attribute
   * @type {number}
  ...
  /**
   * @method
   * @type {(tab: XDocTabElement, animate: boolean) => Promise<void>}
   */
   ...
   *
   * @method
   * @type {(distance: number) => Promise<void>}
   */
  ...
  #onTabPointerDown(pointerDownEvent) {
